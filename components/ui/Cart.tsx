...
const Cart = () => {
    ...
    return (
        <Link
            ...
            <span className='text-white absolute right-0 -top-[5px] bg-red-500 w-4 h-4  rounded-full text-center text-[10px] font-bol md:rounded-none md:bg-transparent md:static md:text-lg md:h-fit md:w-fit '>
                {products.length}
            </span>
        </Link>
    );
